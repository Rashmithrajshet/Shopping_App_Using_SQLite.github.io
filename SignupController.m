...
- (IBAction)btnClintSignup:(id)sender {
    ClientViewController *clientpage = [[ClientViewController alloc] initWithNibName:@"ClientViewController" bundle:nil];
    [self.navigationController pushViewController:clientpage animated:YES];
}
